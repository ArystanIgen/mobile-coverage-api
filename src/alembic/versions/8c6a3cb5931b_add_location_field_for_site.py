"""add location field for site

Revision ID: 8c6a3cb5931b
Revises: 13fc4f3850c2
Create Date: 2025-11-25 00:33:19.866382
...
revision = '8c6a3cb5931b'
down_revision = '13fc4f3850c2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('site', sa.Column('location', geoalchemy2.types.Geography(geometry_type='POINT', srid=4326, dimension=2, from_text='ST_GeogFromText', name='geography', nullable=False), nullable=False))
